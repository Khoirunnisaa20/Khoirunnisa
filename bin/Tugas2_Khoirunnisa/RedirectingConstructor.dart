...
void main() {
  var person1 = Person.withNama("Khoirunnisa");
  var person2 = Person.withAddress("Banjarmasin");
  var person3 = Person("Putri", "Samarinda");
...
class Person {
  ...
  Person.withNama(String nama) : this(nama, "Sungai Andai");
  Person.withAddress(String alamat) : this("Felpes", alamat);
}